...
const createSliderItem = (req, res) => {
  try {
    ...
    const sliderItem = SliderItem.create({ title, subtitle, mediaType, mediaId, order, isActive: true });
...
const updateSliderItem = (req, res) => {
  try {
    ...
    const updated = SliderItem.update(req.params.id, { title, subtitle, mediaType, mediaId, order });
